  ...
  <div class="grid min-h-screen grid-cols-10">
    <div class="col-span-full py-6 px-4 sm:py-12 lg:col-span-6 lg:py-24">
      <div class="mx-auto w-full max-w-lg">
        <h1 class="relative text-2xl font-medium text-gray-700 sm:text-3xl">Secure Checkout<span class="mt-2 block h-1 w-10 bg-gray-900 sm:w-20"></span></h1>
        ...
        <p class="mt-10 text-center text-sm font-semibold text-gray-500">By placing this order you agree to the <a href="#" class="whitespace-nowrap text-blue-400 underline hover:text-teal-600">Terms and Conditions</a></p>
        <button type="submit" class="mt-4 inline-flex w-full items-center justify-center rounded bg-gray-900 py-2.5 px-4 text-base font-semibold tracking-wide text-white text-opacity-80 outline-none ring-offset-2 transition hover:text-opacity-100 focus:ring-2 focus:ring-teal-500 sm:text-lg">Place Order</button>
      </div>
    </div>
        ...
        <ul class="space-y-5">
          <li class="flex justify-between">
            <div class="inline-flex">
              <img src="https://static.nike.com/a/images/t_PDP_144_v1/f_auto/cc0a35b0-b3b8-427c-bf2c-334e0c4beeca/sb-logo-skate-t-shirt-LBBxZV.png" alt="" class="max-h-16" />
              <div class="ml-3">
                <p class="text-base font-semibold text-white">Nike Sb</p>
                <p class="text-sm font-medium text-white text-opacity-80">T-Shirt</p>
              </div>
            </div>
            <p class="text-sm font-semibold text-white">Rp 369,000</p>
          </li>
          <li class="flex justify-between">
            <div class="inline-flex">
              <img src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/bb96c08d-a9f6-4ac2-80fc-24ccb9dfecff/nikecourt-dri-fit-victory-23cm-tennis-shorts-VcGQd1.png" alt="" class="max-h-16" />
              <div class="ml-3">
                <p class="text-base font-semibold text-white">NikeCourt Dri-FIT Victory</p>
                <p class="text-sm font-medium text-white text-opacity-80">Short Pants</p>
              </div>
            </div>
            <p class="text-sm font-semibold text-white">Rp 479,000</p>
          </li>
        </ul>
        <div class="my-5 h-0.5 w-full bg-white bg-opacity-30"></div>
        <div class="space-y-2">
          <p class="flex justify-between text-lg font-bold text-white"><span>Total price:</span><span>Rp 978.000</span></p>
          <p class="flex justify-between text-sm font-medium text-white"><span>Vat: 10%</span><span>Rp 55.000</span></p>
        </div>
      </div>
      <div class="relative mt-10 text-white">
        <h3 class="mb-5 text-lg font-bold">Support</h3>
        <p class="text-sm font-semibold">+68 813 1268 5182 <span class="font-light">(International)</span></p>
        <p class="mt-1 text-sm font-semibold">rahmanrusmana27@gmail.com <span class="font-light">(Email)</span></p>
