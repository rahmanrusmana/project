    ...
    <div class="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
      <div class="flex-auto p-6">
        ...
        <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
          <a href="#" class="flex cursor-pointer items-center gap-2 text-black-500 no-underline hover:text-black-500">
            <span class="flex-shrink-0 text-3xl font-black lowercase tracking-tight opacity-100">Nike</span>
          </a>
        </div>
        <!-- /Logo -->
        <h4 class="mb-2 font-medium text-gray-700 xl:text-xl">Welcome To My Website</h4>
        ...
        <form id="" class="mb-4" action="#" method="POST" @submit.prevent="performLogin">
          <div class="mb-4">
            ...
            <input type="email" class="block w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-black-500 focus:bg-white focus:text-gray-600 focus:shadow" id="email" name="email-username" placeholder="enter your e-mail" autofocus="" v-model="email" required />
          </div>
          <div class="mb-4">
            ...
            <div class="relative flex w-full flex-wrap items-stretch">
              <input type="password" id="password" class="relative block flex-auto cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-blue-500 focus:bg-white focus:text-gray-600 focus:shadow" name="password" placeholder="enter your passwrd" v-model="password" required/>
            </div>
          </div>
          <div class="mb-4">
            <div class="block">
          ...
          <div class="mb-4">
            <button class="grid w-full cursor-pointer select-none rounded-md border border-black-500 bg-gray-900 py-2 px-5 text-center align-middle text-sm text-white shadow " type="submit">Sig In</button>
          </div>
        </form>
